...
Pro tento útok je zapotřebí zařízení schopné emulovat karty MIFARE Classic vybavené obsahem paměti karty oběti. Chameleon Mini je schopný této emulace, ale lze s jeho pomocí získat pouze UID dané karty. Zařízení je tedy schopné obelstít pouze antikolizní fázi. Jako cíl útoku byly vybrány vstupní dveře fakulty vybavené čtecím zařízením. \par
