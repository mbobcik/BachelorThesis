...
Slotu s konfigurací virtualizace karty můžeme nastavit libovolné UID příkazem \verb|UID=<UID>|. Stejně jako v předchozím případě, neznámé UID zjistíme voláním \verb|UID?|.
