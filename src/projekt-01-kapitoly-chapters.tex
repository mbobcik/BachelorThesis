...
%\hspace*{-0.85cm}
%\scalebox{1.2}{
%    \includegraphics [width=0.9\textwidth]{obrazky-figures/SectorTrailerStructure.png}}
%\end{minipage}\hfill
%\begin{minipage}{0.48\textwidth}
%\centering
%\hspace*{-2cm}
...
\begin{figure*}[H]\centering
  \centering
  \includegraphics[width=\linewidth,height=1.7in]{obrazky-figures/LogicalStructureBetter.png}\\[1pt]  
  \caption{Struktura paměti sector traileru a bloku s hodnotou\cite{PracticalAttackOnMIFARE}}    
  \label{obrazekStrukturaPameti}
  
\end{figure*}

LogicalStructureBetter.png
